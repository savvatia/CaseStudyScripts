...
{   
	text 
	{
		caption = "Welcome.\nThe practice session is about to start.";
	};
	x = 0;
	y = 0;
} P_Start_Exp;
...
int N_of_Trials = 10;                               # Number of Experimental Trials per run.  
...
F_Session_List.open("practiceList.txt");
