...
#This script runs a TD group vs. Case Singleton T-test on the story vs. baseline contrast (in this case beta image stored in sub-brick 10) 
...
cd ${output_path}
    ...
    3dttest++ \
    -singletonA \
    caseC1 ${top_path}caseC1/task/MNISpace/stats.C1+tlrc'[10]' \
    -setB TD \
    ...
    -debug\
    -prefix 3dttest_Singleton_Story
